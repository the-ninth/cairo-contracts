...
func FirstRelicCombat_init_chests{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
...
func _fetch_outer_empty_coordinate{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    combat_id: felt, seed: felt
) -> (coordinate: Coordinate, next_seed: felt) {
    alloc_locals;
...
func _fetch_relic_gate_coordinate{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    combat_id: felt, seed: felt
) -> (coordinate: Coordinate, next_seed: felt) {
    alloc_locals;
    ...
    let exist = number;
    if (exist != 0) {
        let (local coordinate, local next_seed) = _fetch_relic_gate_coordinate(
            combat_id, next_seed
        );
        return (coordinate, next_seed);
    }
...
func _use_prop_effect_damage_down{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    damage: felt, combat_id: felt, account: felt
) -> (damage: felt) {
