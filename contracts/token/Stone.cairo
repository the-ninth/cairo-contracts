...
from contracts.access.library import ROLE_STONE_MINTER
...
@storage_var
func Stone_access_contract() -> (addr: felt) {
}
...
func constructor{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    ERC20.initializer('Ninth Stone', 'NSTONE', 0);
    Stone_access_contract.write(access_contract);
    return ();
}
...
func mint{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    IAccessControl.onlyRole(
        contract_address=access_contract, role=ROLE_STONE_MINTER, account=caller
    );
