...
class MockSigner(BaseSigner):
    ...
    def __init__(self, private_key):
        ...
        # self.class_hash = get_class_hash("/home/lighthouse/the-ninth/cairo-contracts/.venv/lib/python3.9/site-packages/openzeppelin/account/presets/Account.cairo",TRUE)
